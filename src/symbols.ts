...
const SYMBOLMAP: Map<string, {
  ...
  ['otherwise', { type: TokenTypes.Text, tex: 'if' }],
  ...
  ['abs', { type: TokenTypes.OperatorBrace, tex: '\\left|$1\\right|' }],
  ['norm', { type: TokenTypes.OperatorBrace, tex: '\\left\\|$1\\right\\|' }],
  ['floor', { type: TokenTypes.OperatorBrace, tex: '\\left\\lfloor$1\\right\\rfloor' }],
  ['ceil', { type: TokenTypes.OperatorBrace, tex: '\\left\\lceil$1\\right\\rceil' }],
