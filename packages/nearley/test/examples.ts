...
const passedExamples: Example[] = [
  ...
  { input: '[a;b;c]', tex: '\\left[\\begin{array}{c}a \\\\ b \\\\ c\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mi>a</mi></mtd></mtr><mtr><mtd><mi>b</mi></mtd></mtr><mtr><mtd><mi>c</mi></mtd></mtr></mtable><mo>]</mo></mrow>' },
  { input: '[a, b; c, d;:}', tex: '\\left[\\begin{array}{cc}a & b \\\\ c & d \\\\ \\end{array}\\right.', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mi>a</mi></mtd><mtd><mi>b</mi></mtd></mtr><mtr><mtd><mi>c</mi></mtd><mtd><mi>d</mi></mtd></mtr></mtable></mrow>' },
  ...
  { input: 'ddfx , dd^2 f x , ddot x', tex: '\\frac{ \\text{d} f }{ \\text{d} x } , \\frac{ \\text{d}^2 f }{ \\text{d} x^2 } , \\ddot{ x }', mathml: '<mrow><mfrac><mrow><mtext>d</mtext><mi>f</mi></mrow><mrow><mtext>d</mtext><mi>x</mi></mrow></mfrac><mo>,</mo><mfrac><mrow><msup><mtext>d</mtext><mn>2</mn></msup><mi>f</mi></mrow><mrow><mtext>d</mtext><msup><mi>x</mi><mn>2</mn></msup></mrow></mfrac><mo>,</mo><mover><mi>x</mi><mo>..</mo></mover></mrow>' },
  { input: 'ppfx', tex: '\\frac{ \\partial f }{ \\partial x }', mathml: '<mfrac><mrow><mo>∂</mo><mi>f</mi></mrow><mrow><mo>∂</mo><mi>x</mi></mrow></mfrac>' },
  { input: 'pp {::} x', tex: '\\frac{ \\partial  }{ \\partial x }', mathml: '<mfrac><mrow><mo>∂</mo><mrow><mrow></mrow></mrow></mrow><mrow><mo>∂</mo><mi>x</mi></mrow></mfrac>' },
  { input: 'pp^3 f (x y^2)', tex: '\\frac{ \\partial^3 f }{ \\partial x\\partial y^2 }', mathml: '<mfrac><mrow><msup><mo>∂</mo><mn>3</mn></msup><mi>f</mi></mrow><mrow><mrow><mo>∂</mo><mi>x</mi></mrow><mrow><mo>∂</mo><msup><mi>y</mi><mn>2</mn></msup></mrow></mrow></mfrac>' },
  ...
  { input: '|a, b; c, d|', tex: '\\left|\\begin{array}{cc}a & b \\\\ c & d\\end{array}\\right|', mathml: '<mrow><mo>|</mo><mtable><mtr><mtd><mi>a</mi></mtd><mtd><mi>b</mi></mtd></mtr><mtr><mtd><mi>c</mi></mtd><mtd><mi>d</mi></mtd></mtr></mtable><mo>|</mo></mrow>' },
  { input: '|x| = { x, if x > 0; -x, otherwise :}', tex: '\\left|x\\right| = \\left\\lbrace{}\\begin{array}{ll}x & \\text{if\\quad} x > 0 \\\\ - x & \\text{otherwise\\quad}\\end{array}\\right.', mathml: '<mrow><mrow><mo>|</mo><mi>x</mi><mo>|</mo></mrow><mo>=</mo><mrow><mo>{</mo><mtable><mtr><mtd><mi>x</mi></mtd><mtd><mrow><mrow><mtext>if</mtext><mspace width="1ex"></mspace></mrow><mi>x</mi><mo>&gt;</mo><mn>0</mn></mrow></mtd></mtr><mtr><mtd><mrow><mo>-</mo><mi>x</mi></mrow></mtd><mtd><mrow><mtext>otherwise</mtext><mspace width="1ex"></mspace></mrow></mtd></mtr></mtable></mrow></mrow>' },
  ...
  { input: 'a^2 choose b^2', tex: '{ a^2 \\choose b^2 }', mathml: '<mrow><mo>(</mo><mtable><mtr><mtd><msup><mi>a</mi><mn>2</mn></msup></mtd></mtr><mtr><mtd><msup><mi>b</mi><mn>2</mn></msup></mtd></mtr></mtable><mo>)</mo></mrow>' },
  ...
  { input: '[1, 2]', tex: '\\left[1, 2\\right]', mathml: '<mrow><mo>[</mo><mn>1</mn><mo>,</mo><mn>2</mn><mo>]</mo></mrow>' },
  { input: '[1, 2; 3]', tex: '\\left[\\begin{array}{cc}1 & 2 \\\\ 3\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr><mtr><mtd><mn>3</mn></mtd></mtr></mtable><mo>]</mo></mrow>' },
  { input: '[1, 2; ,3]', tex: '\\left[\\begin{array}{cc}1 & 2 \\\\  & 3\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr><mtr><mtd><mrow></mrow></mtd><mtd><mn>3</mn></mtd></mtr></mtable><mo>]</mo></mrow>' },
  { input: '[1, 2;]', tex: '\\left[\\begin{array}{cc}1 & 2 \\\\ \\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr></mtable><mo>]</mo></mrow>' },

  { input: '| |', tex: '\\left|\\right|', mathml: '<mrow><mo>|</mo><mrow></mrow><mo>|</mo></mrow>' },
  { input: '|1|', tex: '\\left|1\\right|', mathml: '<mrow><mo>|</mo><mn>1</mn><mo>|</mo></mrow>' },
  { input: '|1,|', tex: '\\left|1, \\right|', mathml: '<mrow><mo>|</mo><mn>1</mn><mo>,</mo><mrow></mrow><mo>|</mo></mrow>' },
  { input: '|1;|', tex: '\\left|\\begin{array}{c}1 \\\\ \\end{array}\\right|', mathml: '<mrow><mo>|</mo><mtable><mtr><mtd><mn>1</mn></mtd></mtr></mtable><mo>|</mo></mrow>' },
  { input: '|1, 2|', tex: '\\left|1, 2\\right|', mathml: '<mrow><mo>|</mo><mn>1</mn><mo>,</mo><mn>2</mn><mo>|</mo></mrow>' },
  { input: '|1, 2; 3|', tex: '\\left|\\begin{array}{cc}1 & 2 \\\\ 3\\end{array}\\right|', mathml: '<mrow><mo>|</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr><mtr><mtd><mn>3</mn></mtd></mtr></mtable><mo>|</mo></mrow>' },
  { input: '|1, 2; ,3|', tex: '\\left|\\begin{array}{cc}1 & 2 \\\\  & 3\\end{array}\\right|', mathml: '<mrow><mo>|</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr><mtr><mtd><mrow></mrow></mtd><mtd><mn>3</mn></mtd></mtr></mtable><mo>|</mo></mrow>' },
  { input: '|1, 2;|', tex: '\\left|\\begin{array}{cc}1 & 2 \\\\ \\end{array}\\right|', mathml: '<mrow><mo>|</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr></mtable><mo>|</mo></mrow>' },

  { input: '[1, 2 | 3; 4, 5 | 6]', tex: '\\left[\\begin{array}{cc|c}1 & 2 & 3 \\\\ 4 & 5 & 6\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd><mtd><mn>3</mn></mtd></mtr><mtr><mtd><mn>4</mn></mtd><mtd><mn>5</mn></mtd><mtd><mn>6</mn></mtd></mtr></mtable><mo>]</mo></mrow>' },
  { input: '[1, 2 | 3; 4 | 5, 6]', tex: '\\left[\\begin{array}{c|c|c}1 & 2 & 3 \\\\ 4 & 5 & 6\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd><mtd><mn>3</mn></mtd></mtr><mtr><mtd><mn>4</mn></mtd><mtd><mn>5</mn></mtd><mtd><mn>6</mn></mtd></mtr></mtable><mo>]</mo></mrow>' },
  { input: '[a, b; [1, 2; 3, 4], d]', tex: '\\left[\\begin{array}{cc}a & b \\\\ \\left[\\begin{array}{cc}1 & 2 \\\\ 3 & 4\\end{array}\\right] & d\\end{array}\\right]', mathml: '<mrow><mo>[</mo><mtable><mtr><mtd><mi>a</mi></mtd><mtd><mi>b</mi></mtd></mtr><mtr><mtd><mrow><mo>[</mo><mtable><mtr><mtd><mn>1</mn></mtd><mtd><mn>2</mn></mtd></mtr><mtr><mtd><mn>3</mn></mtd><mtd><mn>4</mn></mtd></mtr></mtable><mo>]</mo></mrow></mtd><mtd><mi>d</mi></mtd></mtr></mtable><mo>]</mo></mrow>' },
...
\end{aligned}`,
  ...
  { input: '(n) choose (k) = n!/(n!(n-k)!)', tex: '{ n \\choose k } = \\frac{ { n! } }{ { n! } { \\left(n - k\\right)! } }', mathml: '<mrow><mrow><mo>(</mo><mtable><mtr><mtd><mrow><mi>n</mi></mrow></mtd></mtr><mtr><mtd><mrow><mi>k</mi></mrow></mtd></mtr></mtable><mo>)</mo></mrow><mo>=</mo><mfrac><mrow><mi>n</mi><mo>!</mo></mrow><mrow><mrow><mi>n</mi><mo>!</mo></mrow><mrow><mrow><mo>(</mo><mi>n</mi><mo>-</mo><mi>k</mi><mo>)</mo></mrow><mo>!</mo></mrow></mrow></mfrac></mrow>' },
