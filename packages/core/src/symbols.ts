...
const SYMBOLMAP: Map<string, {
  ...
  ['Hat', { type: TokenTypes.OperatorA, tex: '\\widehat{ $1 }' }],
  ['widetilde', { type: TokenTypes.OperatorA, tex: '\\widetilde{ $1 }' }],
  ['ol', { type: TokenTypes.OperatorA, tex: '\\overline{ $1 }' }],
  ['overline', { type: TokenTypes.OperatorA, tex: '\\overline{ $1 }' }],
  ...
  ['Vec', { type: TokenTypes.OperatorA, tex: '\\overrightarrow{ $1 }' }],
  ['tilde', { type: TokenTypes.OperatorA, tex: '\\tilde{ $1 }' }],
  ['Tilde', { type: TokenTypes.OperatorA, tex: '\\widetilde{ $1 }' }],
  ...
  ['underline', { type: TokenTypes.OperatorA, tex: '\\underline{ $1 }' }],
  ['underbrace', { type: TokenTypes.OperatorA, tex: '\\underbrace{ $1 }' }],
  ['ubrace', { type: TokenTypes.OperatorA, tex: '\\underbrace{ $1 }' }],
  ['overbrace', { type: TokenTypes.OperatorA, tex: '\\overbrace{ $1 }' }],
  ['obrace', { type: TokenTypes.OperatorA, tex: '\\overbrace{ $1 }' }],
